...
data = pd.read_csv('D:/Hassan/7th sem assessment/tiktokdata/tiktok_performance.csv')
...
data['engagement_rate'] = (data['User_Likes'] / data['User_Followers']) * 100
...
top_videos = data.sort_values(by='engagement_rate', ascending=False).head(10)
